...
int main(void){
    ...
    switch (Linux)
    {
      ...
      case 13:system("clear;sleep 4");break;
      case 14:printf("classes.dex文件已经准备好\n\n\n>\a\n \n\ntel in log -magisk 5ks...\a\nokey!\a\n\nokey!\a ");system("sleep 2");break;
      ...
      case 20:system("ping baidu.com");break;
      case 21:system("ping sogou.com");break;
      case 22:printf("0:shell\n1~10:print num\n11~21:sh void\n22:print help\n\a  ");break;
